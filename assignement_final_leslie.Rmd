...
patients. Unfortunatly, some of them are mixed (cloud of blue and red points) in a same area. These cases were not clustered correctly. This mixture could be, probably
to the fact that many features correlate. Thereby,we will try to observe any correlation between features to determine which feature are correlated.
