...
print(paste(paste0("k=11: the whole dataset's score is ", best_knn_seperate_cv_stats$General),
...
print(paste(paste0("CV: the whole dataset's sscore = ", knn_cv_stats$General ),
...
best_knn_stats["CV, selected",]<-knn_cv_new_stats
```
...
knn_seperate_cv_stats_z_new <- data.frame(Accuracy=accuracy(knn_table_9_z_new)$.estimate,
                           Sensitivity=round(sensitivity(knn_table_9_z_new),3), 
                           Precision=round(precision(knn_table_9_z_new),3), 
                           Specificity=round(specificity(knn_table_9_z_new),3),k="k=9")
...
print(paste(paste0("k=9: the whole z-scaled dataset's score = ",knn_seperate_cv_stats_z_best$General),
...
```{r message=FALSE, warning=FALSE, echo=FALSE}
print(paste(paste0("CV: the whole z-scaled dataset's score using is ",knn_cv_stats$General),
