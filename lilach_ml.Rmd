...
knitr::kable(svm_best_stats)%>% kable_paper("striped", full_width = F) %>% column_spec(6, bold = T) %>%  row_spec(1, bold = T, color = "black", background = "yellow")
...
```
```{r}
print.data.frame(best_knn_stats[,-5])
```
