...
```{r general conclusion and extra, echo=FALSE, message=FALSE, warning=FALSE}
...
ggroc(list(SVM=pROC_svm_rbf, KNN=pROC_knn_3_z_new, DF=pROC_DT, RF=pROC_DT))+labs(title = "all algotithms")
```
