...
library(tidyverse)    # data manipulation and visualization, including ggplot2
...
```{r}
# apply model in training data (63th column is the label to be predicted)
...
CrossTable(data_test$Class, DT_pred, prop.chisq = FALSE, prop.c = FALSE, prop.r = FALSE, dnn = c('actual class', 'predicted class'))
```
...
CrossTable(data_test$Class , DT_boost_pred10,
...
dt_cost_pred <- predict(dt_cost, data_test)

CrossTable(data_test$Class, dt_cost_pred, prop.chisq = FALSE, prop.c = FALSE, prop.r = FALSE, dnn = c('actual class', 'predicted class'))
```
