...
```{r better splitting, message=FALSE, warning=FALSE, echo=FALSE, results='hide'}
...
```{r normalization, results='hide', message=FALSE, warning=FALSE, results='hide'}
...
```
```{r, message=FALSE, warning=FALSE, echo=FALSE,fig.show = 'hold'}
gl_pca_plot
```
...
```{r correlation, message=FALSE, warning=FALSE, results='hide',fig.show = 'hold'}
...
```
```{r , message=FALSE, warning=FALSE, echo=FALSE, results='hide',fig.show = 'hold'}
...
```{r PCA, message=FALSE, warning=FALSE,  results='hide', fig.show='hold'}
...
```{r rf_fit, message=FALSE, warning=FALSE, results='hide', fig.show='hide'}
# train model
...
```{r RF folds, message=FALSE, warning=FALSE, results='hide',fig.show='hold'}
...
rf_fit_rs
```
```{r message=FALSE, warning=FALSE, fig.show='hold',echo=FALSE}
...
```{r Tuning tune_spec, message=FALSE, warning=FALSE, results='hide',fig.show='hide'}
...
```{r Tuning tree_grid, message=FALSE, warning=FALSE, results='hide', fig.show='hide'}
...
```{r Tuning tree_wf,message=FALSE, warning=FALSE, results='hide', fig.show='hide'}
# define the workflow
...
```{r RF plot preformance, message=FALSE, warning=FALSE, echo=FALSE, results='hide', fig.show='hold'}
# plot preformance
tree_res %>%
  collect_metrics() %>%
...
```{r  Exploring results final_tree, message=FALSE, warning=FALSE,results='hide',echo=FALSE}
